...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('queued', 'provisioning', 'running', 'extracting', 'loading', 'complete', 'failed', 'cancelled', name='job_status', native_enum=False), nullable=False),
    sa.Column('progress_pct', sa.Float(), nullable=True),
    sa.Column('executor', sa.Enum('local', 'none', 'gce', name='job_executor', native_enum=False), nullable=False),
    ...
    sa.Column('severity', sa.Enum('error', 'warning', 'info', name='issue_severity', native_enum=False), nullable=False),
